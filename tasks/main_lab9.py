...
Net6 = Network("../resources/nodes_full_fixed_rate.json")       # 1
# Net6 = Network("../resources/nodes_full_flex_rate.json")      # 2
# Net6 = Network("../resources/nodes_full_shannon.json")        # 3
Net6.connect()  # recall connect to create the Network
# Net6.draw()     # draw the Network
Net6.weighted_paths_dataframe()  # recall weighted_paths to calculate the latency and snr of paths
Net6.route_space_dataframe()

node_list = list(Net6.nodes.keys())  # the elements of dictionary "nodes" are taken and insert in a list "node_list"
...
Net6.stream(connection_obj_list, signal_power, key="snr")
...
# plt.savefig('../results/Distribution_Bit_Rate_FIXED_RATE_Lab9')      # 1
# plt.savefig('../results/Distribution_Bit_Rate_FLEX_RATE_Lab9')     # 2
# plt.savefig('../results/Distribution_Bit_Rate_SHANNON_lab9')       # 3
